...
namespace ore {
    namespace ui {
        ...
        static const std::unordered_map<ore::ui::Font, std::vector<std::string>> TTFFilenames {
        ...
        class FontCache {
            ...
            void loadFont(nk_context *context, ore::ui::Font face, unsigned int size);
        public:
            void initialize();
            void setFont(nk_context* context, ore::ui::Font face, unsigned int size);
        };
    }
}
