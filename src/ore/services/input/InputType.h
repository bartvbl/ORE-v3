...
namespace ore {
    namespace input {
        enum class InputType {
            ...
            CONTROLLER_BUTTON_DPAD_LEFT = 137,
            CONTROLLER_BUTTON_DPAD_RIGHT = 138,
            CONTROLLER_BUTTON_DPAD_UP = 139,
            CONTROLLER_BUTTON_DPAD_DOWN = 140,
            CONTROLLER_BUTTON_BUMPER_LEFT = 141,
            CONTROLLER_BUTTON_BUMPER_RIGHT = 142,
            CONTROLLER_BUTTON_BACK = 143,
            CONTROLLER_BUTTON_START = 144,
            CONTROLLER_BUTTON_THUMB_LEFT = 145,
            CONTROLLER_BUTTON_THUMB_RIGHT = 146,
            CONTROLLER_BUTTON_GUIDE = 147,
        ...
        const InputType CONTROLLER_BUTTON_END = ore::input::InputType::CONTROLLER_BUTTON_GUIDE;
